...
export const msg = $root.msg = (() => {
    ...
    msg.UserLoginCmd = (function() {
         ...
         */
        UserLoginCmd.decode = function decode(reader, length, error) {
         ...
         */
        UserLoginCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.UserLoginCmd";
        };
    ...
    msg.UserLoginResult = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        UserLoginResult.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Gets the default type url for UserLoginResult
         * @function getTypeUrl
         * @memberof msg.UserLoginResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        UserLoginResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.UserLoginResult";
        };
    ...
    msg.GetSMSAuthCodeCmd = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GetSMSAuthCodeCmd.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Gets the default type url for GetSMSAuthCodeCmd
         * @function getTypeUrl
         * @memberof msg.GetSMSAuthCodeCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        GetSMSAuthCodeCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.GetSMSAuthCodeCmd";
        };
    ...
    msg.GetSMSAuthCodeResult = (function() {
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        GetSMSAuthCodeResult.decode = function decode(reader, length, error) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
        ...
        /**
         * Gets the default type url for GetSMSAuthCodeResult
         * @function getTypeUrl
         * @memberof msg.GetSMSAuthCodeResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        GetSMSAuthCodeResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.GetSMSAuthCodeResult";
        };
