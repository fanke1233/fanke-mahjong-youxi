...
export const msg = $root.msg = (() => {
     ...
     * @property {number} _MahjongPiaoLaiCmd=1073 _MahjongPiaoLaiCmd value
     * @property {number} _MahjongPiaoLaiResult=1074 _MahjongPiaoLaiResult value
     * @property {number} _MahjongPiaoLaiBroadcast=1075 _MahjongPiaoLaiBroadcast value
     * @property {number} _MahjongSelectTilePreviewCmd=1076 _MahjongSelectTilePreviewCmd value
    ...
    msg.MJ_weihai_MsgCodeDef = (function() {
        ...
        values[valuesById[1073] = "_MahjongPiaoLaiCmd"] = 1073;
        values[valuesById[1074] = "_MahjongPiaoLaiResult"] = 1074;
        values[valuesById[1075] = "_MahjongPiaoLaiBroadcast"] = 1075;
        values[valuesById[1076] = "_MahjongSelectTilePreviewCmd"] = 1076;
        values[valuesById[1077] = "_MahjongSelectTilePreviewResult"] = 1077;
        return values;
    })();
    ...
    msg.KeyAndVal = (function() {
        ...
        /**
         * Gets the default type url for KeyAndVal
         * @function getTypeUrl
         * @memberof msg.KeyAndVal
         * @static
         ...
         */
        KeyAndVal.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.KeyAndVal";
        };
    ...
    msg.MahjongChiPengGang = (function() {
        ...
        /**
         * Gets the default type url for MahjongChiPengGang
         * @function getTypeUrl
         * @memberof msg.MahjongChiPengGang
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongChiPengGang.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongChiPengGang";
        };
    ...
    msg.MahjongLiangFeng = (function() {
        ...
        /**
         * Gets the default type url for MahjongLiangFeng
         * @function getTypeUrl
         * @memberof msg.MahjongLiangFeng
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongLiangFeng.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongLiangFeng";
        };
    ...
    msg.Player = (function() {
         ...
         * @property {number|null} [laiGenTile] Player laiGenTile
         * @property {number|null} [laiZiTile] Player laiZiTile
         */
        ...
        /**
         * Player laiGenTile.
         * @member {number} laiGenTile
         * @memberof msg.Player
         * @instance
         */
        Player.prototype.laiGenTile = 0;

        /**
         * Player laiZiTile.
         * @member {number} laiZiTile
         * @memberof msg.Player
         * @instance
         */
        Player.prototype.laiZiTile = 0;
        ...
        Player.encode = function encode(message, writer) {
            ...
            if (message.laiGenTile != null && Object.hasOwnProperty.call(message, "laiGenTile"))
                writer.uint32(/* id 19, wireType 0 =*/152).sint32(message.laiGenTile);
            if (message.laiZiTile != null && Object.hasOwnProperty.call(message, "laiZiTile"))
                writer.uint32(/* id 20, wireType 0 =*/160).sint32(message.laiZiTile);
            return writer;
        };
        ...
        Player.verify = function verify(message) {
            ...
            if (message.laiGenTile != null && message.hasOwnProperty("laiGenTile"))
                if (!$util.isInteger(message.laiGenTile))
                    return "laiGenTile: integer expected";
            if (message.laiZiTile != null && message.hasOwnProperty("laiZiTile"))
                if (!$util.isInteger(message.laiZiTile))
                    return "laiZiTile: integer expected";
            return null;
        };
        ...
        Player.fromObject = function fromObject(object) {
            ...
            if (object.laiGenTile != null)
                message.laiGenTile = object.laiGenTile | 0;
        ...
        Player.toObject = function toObject(message, options) {
            ...
            if (message.laiGenTile != null && message.hasOwnProperty("laiGenTile"))
                object.laiGenTile = message.laiGenTile;
            if (message.laiZiTile != null && message.hasOwnProperty("laiZiTile"))
                object.laiZiTile = message.laiZiTile;
            return object;
        };
        ...
        Player.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/msg.Player";
        };
    ...
    msg.JoinRoomBroadcast = (function() {
        ...
        JoinRoomBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/msg.JoinRoomBroadcast";
        };
    ...
    msg.DissolveTheRoomCmd = (function() {
        ...
        /**
         * Gets the default type url for DissolveTheRoomCmd
         * @function getTypeUrl
         * @memberof msg.DissolveTheRoomCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DissolveTheRoomCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DissolveTheRoomCmd";
        };
    ...
    msg.DissolveTheRoomResult = (function() {
        ...
        /**
         * Gets the default type url for DissolveTheRoomResult
         * @function getTypeUrl
         * @memberof msg.DissolveTheRoomResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DissolveTheRoomResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DissolveTheRoomResult";
        };
    ...
    msg.DissolveTheRoomBroadcast = (function() {
        ...
        /**
         * Gets the default type url for DissolveTheRoomBroadcast
         * @function getTypeUrl
         * @memberof msg.DissolveTheRoomBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DissolveTheRoomBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DissolveTheRoomBroadcast";
        };
        ...
        DissolveTheRoomBroadcast.Waiting4User = (function() {
            ...
            /**
             * Gets the default type url for Waiting4User
             * @function getTypeUrl
             * @memberof msg.DissolveTheRoomBroadcast.Waiting4User
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            Waiting4User.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/msg.DissolveTheRoomBroadcast.Waiting4User";
            };
    ...
    msg.DissolutionVoteCmd = (function() {
        ...
        /**
         * Gets the default type url for DissolutionVoteCmd
         * @function getTypeUrl
         * @memberof msg.DissolutionVoteCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DissolutionVoteCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DissolutionVoteCmd";
        };
    ...
    msg.DissolutionVoteResult = (function() {
        ...
        /**
         * Gets the default type url for DissolutionVoteResult
         * @function getTypeUrl
         * @memberof msg.DissolutionVoteResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DissolutionVoteResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DissolutionVoteResult";
        };
    ...
    msg.DissolutionVoteBroadcast = (function() {
        ...
        /**
         * Gets the default type url for DissolutionVoteBroadcast
         * @function getTypeUrl
         * @memberof msg.DissolutionVoteBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DissolutionVoteBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DissolutionVoteBroadcast";
        };
    ...
    msg.DissolveSuccezzBroadcast = (function() {
        ...
        /**
         * Gets the default type url for DissolveSuccezzBroadcast
         * @function getTypeUrl
         * @memberof msg.DissolveSuccezzBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DissolveSuccezzBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DissolveSuccezzBroadcast";
        };
    ...
    msg.FireAPlayerCmd = (function() {
        ...
        /**
         * Gets the default type url for FireAPlayerCmd
         * @function getTypeUrl
         * @memberof msg.FireAPlayerCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        FireAPlayerCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.FireAPlayerCmd";
        };
    ...
    msg.FireAPlayerResult = (function() {
        ...
        /**
         * Gets the default type url for FireAPlayerResult
         * @function getTypeUrl
         * @memberof msg.FireAPlayerResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        FireAPlayerResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.FireAPlayerResult";
        };
    ...
    msg.FireAPlayerBroadcast = (function() {
        ...
        /**
         * Gets the default type url for FireAPlayerBroadcast
         * @function getTypeUrl
         * @memberof msg.FireAPlayerBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        FireAPlayerBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.FireAPlayerBroadcast";
        };
    ...
    msg.QuitRoomCmd = (function() {
        ...
        /**
         * Gets the default type url for QuitRoomCmd
         * @function getTypeUrl
         * @memberof msg.QuitRoomCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        QuitRoomCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.QuitRoomCmd";
        };
    ...
    msg.QuitRoomResult = (function() {
        ...
        /**
         * Gets the default type url for QuitRoomResult
         * @function getTypeUrl
         * @memberof msg.QuitRoomResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        QuitRoomResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.QuitRoomResult";
        };
    ...
    msg.QuitRoomBroadcast = (function() {
        ...
        /**
         * Gets the default type url for QuitRoomBroadcast
         * @function getTypeUrl
         * @memberof msg.QuitRoomBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        QuitRoomBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.QuitRoomBroadcast";
        };
    ...
    msg.SyncRoomDataCmd = (function() {
        ...
        /**
         * Gets the default type url for SyncRoomDataCmd
         * @function getTypeUrl
         * @memberof msg.SyncRoomDataCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        SyncRoomDataCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.SyncRoomDataCmd";
        };
    ...
    msg.SyncRoomDataResult = (function() {
        ...
        /**
         * Gets the default type url for SyncRoomDataResult
         * @function getTypeUrl
         * @memberof msg.SyncRoomDataResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        SyncRoomDataResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.SyncRoomDataResult";
        };
    ...
    msg.ReportGeoLocationCmd = (function() {
        ...
        /**
         * Gets the default type url for ReportGeoLocationCmd
         * @function getTypeUrl
         * @memberof msg.ReportGeoLocationCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        ReportGeoLocationCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.ReportGeoLocationCmd";
        };
    ...
    msg.ReportGeoLocationResult = (function() {
        ...
        /**
         * Gets the default type url for ReportGeoLocationResult
         * @function getTypeUrl
         * @memberof msg.ReportGeoLocationResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        ReportGeoLocationResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.ReportGeoLocationResult";
        };
    ...
    msg.MeasureGeoDistanceCmd = (function() {
        ...
        /**
         * Gets the default type url for MeasureGeoDistanceCmd
         * @function getTypeUrl
         * @memberof msg.MeasureGeoDistanceCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MeasureGeoDistanceCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MeasureGeoDistanceCmd";
        };
    ...
    msg.MeasureGeoDistanceResult = (function() {
        ...
        /**
         * Gets the default type url for MeasureGeoDistanceResult
         * @function getTypeUrl
         * @memberof msg.MeasureGeoDistanceResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MeasureGeoDistanceResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MeasureGeoDistanceResult";
        };
        ...
        MeasureGeoDistanceResult.GeoDistanceItem = (function() {
            ...
            /**
             * Gets the default type url for GeoDistanceItem
             * @function getTypeUrl
             * @memberof msg.MeasureGeoDistanceResult.GeoDistanceItem
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            GeoDistanceItem.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/msg.MeasureGeoDistanceResult.GeoDistanceItem";
            };
    ...
    msg.PrepareCmd = (function() {
        ...
        /**
         * Gets the default type url for PrepareCmd
         * @function getTypeUrl
         * @memberof msg.PrepareCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        PrepareCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.PrepareCmd";
        };
    ...
    msg.PrepareResult = (function() {
         ...
         * @returns {string} The default type url
         */
        PrepareResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.PrepareResult";
        };
    ...
    msg.PrepareBroadcast = (function() {
        ...
        /**
         * Gets the default type url for PrepareBroadcast
         * @function getTypeUrl
         * @memberof msg.PrepareBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        PrepareBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.PrepareBroadcast";
        };
    ...
    msg.OfficialStartCmd = (function() {
        ...
        /**
         * Gets the default type url for OfficialStartCmd
         * @function getTypeUrl
         * @memberof msg.OfficialStartCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        OfficialStartCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.OfficialStartCmd";
        };
    ...
    msg.OfficialStartResult = (function() {
        ...
        /**
         * Gets the default type url for OfficialStartResult
         * @function getTypeUrl
         * @memberof msg.OfficialStartResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        OfficialStartResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.OfficialStartResult";
        };
    ...
    msg.OfficialStartBroadcast = (function() {
        ...
        /**
         * Gets the default type url for OfficialStartBroadcast
         * @function getTypeUrl
         * @memberof msg.OfficialStartBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        OfficialStartBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.OfficialStartBroadcast";
        };
    ...
    msg.SelectPiaoHintBroadcast = (function() {
        ...
        /**
         * Gets the default type url for SelectPiaoHintBroadcast
         * @function getTypeUrl
         * @memberof msg.SelectPiaoHintBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        SelectPiaoHintBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.SelectPiaoHintBroadcast";
        };
    ...
    msg.DingPiaoCmd = (function() {
        ...
        /**
         * Gets the default type url for DingPiaoCmd
         * @function getTypeUrl
         * @memberof msg.DingPiaoCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DingPiaoCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DingPiaoCmd";
        };
    ...
    msg.DingPiaoResult = (function() {
        ...
        /**
         * Gets the default type url for DingPiaoResult
         * @function getTypeUrl
         * @memberof msg.DingPiaoResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DingPiaoResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DingPiaoResult";
        };
    ...
    msg.DingPiaoBroadcast = (function() {
        ...
        /**
         * Gets the default type url for DingPiaoBroadcast
         * @function getTypeUrl
         * @memberof msg.DingPiaoBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        DingPiaoBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.DingPiaoBroadcast";
        };
    ...
    msg.RoundStartedBroadcast = (function() {
        ...
        /**
         * Gets the default type url for RoundStartedBroadcast
         * @function getTypeUrl
         * @memberof msg.RoundStartedBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        RoundStartedBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.RoundStartedBroadcast";
        };
    ...
    msg.MahjongInHandChangedResult = (function() {
         ...
         * @property {number|null} [laiGenTile] MahjongInHandChangedResult laiGenTile
         * @property {number|null} [laiZiTile] MahjongInHandChangedResult laiZiTile
         */
        ...
        /**
         * MahjongInHandChangedResult laiGenTile.
         * @member {number} laiGenTile
         * @memberof msg.MahjongInHandChangedResult
         * @instance
         */
        MahjongInHandChangedResult.prototype.laiGenTile = 0;

        /**
         * MahjongInHandChangedResult laiZiTile.
         * @member {number} laiZiTile
         * @memberof msg.MahjongInHandChangedResult
         * @instance
         */
        MahjongInHandChangedResult.prototype.laiZiTile = 0;
        ...
        MahjongInHandChangedResult.encode = function encode(message, writer) {
            ...
            if (message.laiGenTile != null && Object.hasOwnProperty.call(message, "laiGenTile"))
                writer.uint32(/* id 3, wireType 0 =*/24).sint32(message.laiGenTile);
            if (message.laiZiTile != null && Object.hasOwnProperty.call(message, "laiZiTile"))
                writer.uint32(/* id 4, wireType 0 =*/32).sint32(message.laiZiTile);
            return writer;
        };
        ...
        /**
         * Gets the default type url for MahjongInHandChangedResult
         * @function getTypeUrl
         * @memberof msg.MahjongInHandChangedResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongInHandChangedResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongInHandChangedResult";
        };
    ...
    msg.MahjongInHandChangedBroadcast = (function() {
         ...
         * @property {number|null} [laiGenTile] MahjongInHandChangedBroadcast laiGenTile
         * @property {number|null} [laiZiTile] MahjongInHandChangedBroadcast laiZiTile
         */
        ...
        /**
         * MahjongInHandChangedBroadcast laiGenTile.
         * @member {number} laiGenTile
         * @memberof msg.MahjongInHandChangedBroadcast
         * @instance
         */
        MahjongInHandChangedBroadcast.prototype.laiGenTile = 0;

        /**
         * MahjongInHandChangedBroadcast laiZiTile.
         * @member {number} laiZiTile
         * @memberof msg.MahjongInHandChangedBroadcast
         * @instance
         */
        MahjongInHandChangedBroadcast.prototype.laiZiTile = 0;
        ...
        MahjongInHandChangedBroadcast.encode = function encode(message, writer) {
            ...
            if (message.laiGenTile != null && Object.hasOwnProperty.call(message, "laiGenTile"))
                writer.uint32(/* id 4, wireType 0 =*/32).sint32(message.laiGenTile);
            if (message.laiZiTile != null && Object.hasOwnProperty.call(message, "laiZiTile"))
                writer.uint32(/* id 5, wireType 0 =*/40).sint32(message.laiZiTile);
            return writer;
        };
        ...
        /**
         * Gets the default type url for MahjongInHandChangedBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongInHandChangedBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongInHandChangedBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongInHandChangedBroadcast";
        };
    ...
    msg.MahjongMoPaiResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongMoPaiResult
         * @function getTypeUrl
         * @memberof msg.MahjongMoPaiResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongMoPaiResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongMoPaiResult";
        };
    ...
    msg.MahjongMoPaiBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongMoPaiBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongMoPaiBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongMoPaiBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongMoPaiBroadcast";
        };
    ...
    msg.RedirectActUserIdBroadcast = (function() {
        ...
        /**
         * Gets the default type url for RedirectActUserIdBroadcast
         * @function getTypeUrl
         * @memberof msg.RedirectActUserIdBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        RedirectActUserIdBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.RedirectActUserIdBroadcast";
        };
    ...
    msg.OpRemainTimeBroadcast = (function() {
        ...
        /**
         * Gets the default type url for OpRemainTimeBroadcast
         * @function getTypeUrl
         * @memberof msg.OpRemainTimeBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        OpRemainTimeBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.OpRemainTimeBroadcast";
        };
    ...
    msg.MahjongChuPaiCmd = (function() {
        ...
        /**
         * Gets the default type url for MahjongChuPaiCmd
         * @function getTypeUrl
         * @memberof msg.MahjongChuPaiCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongChuPaiCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongChuPaiCmd";
        };
    ...
    msg.MahjongChuPaiResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongChuPaiResult
         * @function getTypeUrl
         * @memberof msg.MahjongChuPaiResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongChuPaiResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongChuPaiResult";
        };
    ...
    msg.MahjongChuPaiBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongChuPaiBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongChuPaiBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongChuPaiBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongChuPaiBroadcast";
        };
    ...
    msg.ChiChoiceQuestion = (function() {
        ...
        /**
         * Gets the default type url for ChiChoiceQuestion
         * @function getTypeUrl
         * @memberof msg.ChiChoiceQuestion
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        ChiChoiceQuestion.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.ChiChoiceQuestion";
        };
    ...
    msg.LiangFengChoiceQuestion = (function() {
        ...
        /**
         * Gets the default type url for LiangFengChoiceQuestion
         * @function getTypeUrl
         * @memberof msg.LiangFengChoiceQuestion
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        LiangFengChoiceQuestion.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.LiangFengChoiceQuestion";
        };
    ...
    msg.MahjongChiPengGangHuOpHintResult = (function() {
         ...
         * @property {boolean|null} [opHintPiaoLai] MahjongChiPengGangHuOpHintResult opHintPiaoLai
         * @property {boolean|null} [jianZiHuHint] MahjongChiPengGangHuOpHintResult jianZiHuHint
         * @property {Array.<number>|null} [huTileArray] MahjongChiPengGangHuOpHintResult huTileArray
         */
        ...
        /**
         * MahjongChiPengGangHuOpHintResult opHintPiaoLai.
         * @member {boolean} opHintPiaoLai
         * @memberof msg.MahjongChiPengGangHuOpHintResult
         * @instance
         */
        MahjongChiPengGangHuOpHintResult.prototype.opHintPiaoLai = false;

        /**
         * MahjongChiPengGangHuOpHintResult jianZiHuHint.
         * @member {boolean} jianZiHuHint
         * @memberof msg.MahjongChiPengGangHuOpHintResult
         * @instance
         */
        MahjongChiPengGangHuOpHintResult.prototype.jianZiHuHint = false;

        /**
         * MahjongChiPengGangHuOpHintResult huTileArray.
         * @member {Array.<number>} huTileArray
         * @memberof msg.MahjongChiPengGangHuOpHintResult
         * @instance
         */
        MahjongChiPengGangHuOpHintResult.prototype.huTileArray = $util.emptyArray;
        ...
        MahjongChiPengGangHuOpHintResult.encode = function encode(message, writer) {
            ...
            if (message.opHintPiaoLai != null && Object.hasOwnProperty.call(message, "opHintPiaoLai"))
                writer.uint32(/* id 9, wireType 0 =*/72).bool(message.opHintPiaoLai);
            if (message.jianZiHuHint != null && Object.hasOwnProperty.call(message, "jianZiHuHint"))
        ...
        MahjongChiPengGangHuOpHintResult.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 9: {
                        message.opHintPiaoLai = reader.bool();
                        break;
                    }
                case 10: {
                        message.jianZiHuHint = reader.bool();
                        break;
                    }
                case 11: {
        ...
        MahjongChiPengGangHuOpHintResult.verify = function verify(message) {
            ...
            if (message.opHintPiaoLai != null && message.hasOwnProperty("opHintPiaoLai"))
                if (typeof message.opHintPiaoLai !== "boolean")
                    return "opHintPiaoLai: boolean expected";
            if (message.jianZiHuHint != null && message.hasOwnProperty("jianZiHuHint"))
                if (typeof message.jianZiHuHint !== "boolean")
                    return "jianZiHuHint: boolean expected";
        ...
        MahjongChiPengGangHuOpHintResult.fromObject = function fromObject(object) {
            ...
            if (object.opHintPiaoLai != null)
                message.opHintPiaoLai = Boolean(object.opHintPiaoLai);
            if (object.jianZiHuHint != null)
                message.jianZiHuHint = Boolean(object.jianZiHuHint);
        ...
        MahjongChiPengGangHuOpHintResult.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.opHintPiaoLai = false;
                object.jianZiHuHint = false;
            }
            if (message.opHintChi != null && message.hasOwnProperty("opHintChi"))
            ...
            if (message.opHintPiaoLai != null && message.hasOwnProperty("opHintPiaoLai"))
                object.opHintPiaoLai = message.opHintPiaoLai;
            if (message.jianZiHuHint != null && message.hasOwnProperty("jianZiHuHint"))
        ...
        /**
         * Gets the default type url for MahjongChiPengGangHuOpHintResult
         * @function getTypeUrl
         * @memberof msg.MahjongChiPengGangHuOpHintResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongChiPengGangHuOpHintResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongChiPengGangHuOpHintResult";
        };
    ...
    msg.MahjongChiCmd = (function() {
        ...
        /**
         * Gets the default type url for MahjongChiCmd
         * @function getTypeUrl
         * @memberof msg.MahjongChiCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongChiCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongChiCmd";
        };
    ...
    msg.MahjongChiResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongChiResult
         * @function getTypeUrl
         * @memberof msg.MahjongChiResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongChiResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongChiResult";
        };
    ...
    msg.MahjongChiBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongChiBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongChiBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongChiBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongChiBroadcast";
        };
    ...
    msg.MahjongPengCmd = (function() {
        ...
        /**
         * Gets the default type url for MahjongPengCmd
         * @function getTypeUrl
         * @memberof msg.MahjongPengCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongPengCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongPengCmd";
        };
    ...
    msg.MahjongPengResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongPengResult
         * @function getTypeUrl
         * @memberof msg.MahjongPengResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongPengResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongPengResult";
        };
    ...
    msg.MahjongPengBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongPengBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongPengBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongPengBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongPengBroadcast";
        };
    ...
    msg.MahjongGangCmd = (function() {
        ...
        /**
         * Gets the default type url for MahjongGangCmd
         * @function getTypeUrl
         * @memberof msg.MahjongGangCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongGangCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongGangCmd";
        };
    ...
    msg.MahjongMingGangResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongMingGangResult
         * @function getTypeUrl
         * @memberof msg.MahjongMingGangResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongMingGangResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongMingGangResult";
        };
    ...
    msg.MahjongAnGangResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongAnGangResult
         * @function getTypeUrl
         * @memberof msg.MahjongAnGangResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongAnGangResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongAnGangResult";
        };
    ...
    msg.MahjongBuGangResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongBuGangResult
         * @function getTypeUrl
         * @memberof msg.MahjongBuGangResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongBuGangResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongBuGangResult";
        };
    ...
    msg.MahjongMingGangBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongMingGangBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongMingGangBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongMingGangBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongMingGangBroadcast";
        };
    ...
    msg.MahjongAnGangBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongAnGangBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongAnGangBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongAnGangBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongAnGangBroadcast";
        };
    ...
    msg.MahjongBuGangBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongBuGangBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongBuGangBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongBuGangBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongBuGangBroadcast";
        };
    ...
    msg.MahjongLiangDaoCmd = (function() {
        ...
        /**
         * Gets the default type url for MahjongLiangDaoCmd
         * @function getTypeUrl
         * @memberof msg.MahjongLiangDaoCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongLiangDaoCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongLiangDaoCmd";
        };
    ...
    msg.MahjongLiangDaoResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongLiangDaoResult
         * @function getTypeUrl
         * @memberof msg.MahjongLiangDaoResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongLiangDaoResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongLiangDaoResult";
        };
    ...
    msg.MahjongLiangDaoBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongLiangDaoBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongLiangDaoBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongLiangDaoBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongLiangDaoBroadcast";
        };
    ...
    msg.MahjongHuCmd = (function() {
        ...
        /**
         * Gets the default type url for MahjongHuCmd
         * @function getTypeUrl
         * @memberof msg.MahjongHuCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongHuCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongHuCmd";
        };
    ...
    msg.MahjongHuOrZiMoResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongHuOrZiMoResult
         * @function getTypeUrl
         * @memberof msg.MahjongHuOrZiMoResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongHuOrZiMoResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongHuOrZiMoResult";
        };
    ...
    msg.MahjongHuOrZiMoBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongHuOrZiMoBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongHuOrZiMoBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongHuOrZiMoBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongHuOrZiMoBroadcast";
        };
    ...
    msg.MahjongGuoCmd = (function() {
        ...
        /**
         * Gets the default type url for MahjongGuoCmd
         * @function getTypeUrl
         * @memberof msg.MahjongGuoCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongGuoCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongGuoCmd";
        };
    ...
    msg.MahjongGuoResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongGuoResult
         * @function getTypeUrl
         * @memberof msg.MahjongGuoResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongGuoResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongGuoResult";
        };
    ...
    msg.MahjongHuangZhuangBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongHuangZhuangBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongHuangZhuangBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongHuangZhuangBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongHuangZhuangBroadcast";
        };
    ...
    msg.RoundSettlementBroadcast = (function() {
        ...
        /**
         * Gets the default type url for RoundSettlementBroadcast
         * @function getTypeUrl
         * @memberof msg.RoundSettlementBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        RoundSettlementBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.RoundSettlementBroadcast";
        };
        ...
        RoundSettlementBroadcast.SettlementItem = (function() {
            ...
            /**
             * Gets the default type url for SettlementItem
             * @function getTypeUrl
             * @memberof msg.RoundSettlementBroadcast.SettlementItem
             * @static
             * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
             * @returns {string} The default type url
             */
            SettlementItem.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                if (typeUrlPrefix === undefined) {
                    typeUrlPrefix = "type.googleapis.com";
                }
                return typeUrlPrefix + "/msg.RoundSettlementBroadcast.SettlementItem";
            };
    ...
    msg.RoomSettlementBroadcast = (function() {
        ...
        /**
         * Gets the default type url for RoomSettlementBroadcast
         * @function getTypeUrl
         * @memberof msg.RoomSettlementBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        RoomSettlementBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.RoomSettlementBroadcast";
        };
        ...
        RoomSettlementBroadcast.SettlementItem = (function() {
            ...
            SettlementItem.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
                ...
                return typeUrlPrefix + "/msg.RoomSettlementBroadcast.SettlementItem";
            };
    ...
    msg.MahjongLiangFengCmd = (function() {
        ...
        /**
         * Gets the default type url for MahjongLiangFengCmd
         * @function getTypeUrl
         * @memberof msg.MahjongLiangFengCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongLiangFengCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongLiangFengCmd";
        };
    ...
    msg.MahjongLiangFengResult = (function() {
        ...
        /**
         * Gets the default type url for MahjongLiangFengResult
         * @function getTypeUrl
         * @memberof msg.MahjongLiangFengResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongLiangFengResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongLiangFengResult";
        };
    ...
    msg.MahjongLiangFengBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongLiangFengBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongLiangFengBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongLiangFengBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongLiangFengBroadcast";
        };
    ...
    msg.MahjongBuFengCmd = (function() {
         ...
         * @property {number|null} [t0] MahjongBuFengCmd t0
         */
         ...
         * @instance
         */
        MahjongBuFengCmd.prototype.t0 = 0;
        ...
        /**
         * Gets the default type url for MahjongBuFengCmd
         * @function getTypeUrl
         * @memberof msg.MahjongBuFengCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongBuFengCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongBuFengCmd";
        };
    ...
    msg.MahjongBuFengResult = (function() {
         ...
         * @property {msg.IMahjongLiangFeng|null} [mahjongBuFeng] MahjongBuFengResult mahjongBuFeng
         */
        ...
        /**
         * MahjongBuFengResult mahjongBuFeng.
         * @member {msg.IMahjongLiangFeng|null|undefined} mahjongBuFeng
         * @memberof msg.MahjongBuFengResult
         * @instance
         */
        MahjongBuFengResult.prototype.mahjongBuFeng = null;
        ...
        MahjongBuFengResult.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.mahjongBuFeng != null && Object.hasOwnProperty.call(message, "mahjongBuFeng"))
                $root.msg.MahjongLiangFeng.encode(message.mahjongBuFeng, writer.uint32(/* id 1, wireType 2 =*/10).fork()).ldelim();
            return writer;
        };
        ...
        MahjongBuFengResult.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                case 1: {
                        message.mahjongBuFeng = $root.msg.MahjongLiangFeng.decode(reader, reader.uint32());
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        MahjongBuFengResult.fromObject = function fromObject(object) {
            ...
            if (object.mahjongBuFeng != null) {
                ...
                message.mahjongBuFeng = $root.msg.MahjongLiangFeng.fromObject(object.mahjongBuFeng);
            }
            return message;
        };
        ...
        MahjongBuFengResult.toObject = function toObject(message, options) {
            ...
            if (message.mahjongBuFeng != null && message.hasOwnProperty("mahjongBuFeng"))
                object.mahjongBuFeng = $root.msg.MahjongLiangFeng.toObject(message.mahjongBuFeng, options);
            return object;
        };
        ...
        /**
         * Gets the default type url for MahjongBuFengResult
         * @function getTypeUrl
         * @memberof msg.MahjongBuFengResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongBuFengResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongBuFengResult";
        };
    ...
    msg.MahjongBuFengBroadcast = (function() {
         ...
         * @property {msg.IMahjongLiangFeng|null} [mahjongBuFeng] MahjongBuFengBroadcast mahjongBuFeng
         */
        ...
        /**
         * MahjongBuFengBroadcast mahjongBuFeng.
         * @member {msg.IMahjongLiangFeng|null|undefined} mahjongBuFeng
         * @memberof msg.MahjongBuFengBroadcast
         * @instance
         */
        MahjongBuFengBroadcast.prototype.mahjongBuFeng = null;
        ...
        MahjongBuFengBroadcast.encode = function encode(message, writer) {
            ...
            if (message.userId != null && Object.hasOwnProperty.call(message, "userId"))
                writer.uint32(/* id 1, wireType 0 =*/8).sint32(message.userId);
            if (message.mahjongBuFeng != null && Object.hasOwnProperty.call(message, "mahjongBuFeng"))
                $root.msg.MahjongLiangFeng.encode(message.mahjongBuFeng, writer.uint32(/* id 2, wireType 2 =*/18).fork()).ldelim();
            return writer;
        };
        ...
        MahjongBuFengBroadcast.fromObject = function fromObject(object) {
            ...
            if (object.mahjongBuFeng != null) {
                if (typeof object.mahjongBuFeng !== "object")
                    throw TypeError(".msg.MahjongBuFengBroadcast.mahjongBuFeng: object expected");
                message.mahjongBuFeng = $root.msg.MahjongLiangFeng.fromObject(object.mahjongBuFeng);
            }
            return message;
        };
        ...
        /**
         * Gets the default type url for MahjongBuFengBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongBuFengBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongBuFengBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongBuFengBroadcast";
        };

        return MahjongBuFengBroadcast;
    })();

    msg.MahjongPiaoLaiCmd = (function() {

        /**
         * Properties of a MahjongPiaoLaiCmd.
         * @memberof msg
         * @interface IMahjongPiaoLaiCmd
         * @property {number|null} [laiZiTile] MahjongPiaoLaiCmd laiZiTile
         */

        /**
         * Constructs a new MahjongPiaoLaiCmd.
         * @memberof msg
         * @classdesc Represents a MahjongPiaoLaiCmd.
         * @implements IMahjongPiaoLaiCmd
         * @constructor
         * @param {msg.IMahjongPiaoLaiCmd=} [properties] Properties to set
         */
        ...
        /**
         * MahjongPiaoLaiCmd laiZiTile.
         * @member {number} laiZiTile
         * @memberof msg.MahjongPiaoLaiCmd
         * @instance
         */
        MahjongPiaoLaiCmd.prototype.laiZiTile = 0;

        /**
         * Creates a new MahjongPiaoLaiCmd instance using the specified properties.
         * @function create
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {msg.IMahjongPiaoLaiCmd=} [properties] Properties to set
         * @returns {msg.MahjongPiaoLaiCmd} MahjongPiaoLaiCmd instance
         */
        MahjongPiaoLaiCmd.create = function create(properties) {
            return new MahjongPiaoLaiCmd(properties);
        };

        /**
         * Encodes the specified MahjongPiaoLaiCmd message. Does not implicitly {@link msg.MahjongPiaoLaiCmd.verify|verify} messages.
         * @function encode
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {msg.IMahjongPiaoLaiCmd} message MahjongPiaoLaiCmd message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MahjongPiaoLaiCmd.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.laiZiTile != null && Object.hasOwnProperty.call(message, "laiZiTile"))
                writer.uint32(/* id 1, wireType 0 =*/8).sint32(message.laiZiTile);
            return writer;
        };

        /**
         * Encodes the specified MahjongPiaoLaiCmd message, length delimited. Does not implicitly {@link msg.MahjongPiaoLaiCmd.verify|verify} messages.
         * @function encodeDelimited
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {msg.IMahjongPiaoLaiCmd} message MahjongPiaoLaiCmd message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MahjongPiaoLaiCmd.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a MahjongPiaoLaiCmd message from the specified reader or buffer.
         * @function decode
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {msg.MahjongPiaoLaiCmd} MahjongPiaoLaiCmd
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ...
        /**
         * Decodes a MahjongPiaoLaiCmd message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MahjongPiaoLaiCmd.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a MahjongPiaoLaiCmd message.
         * @function verify
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MahjongPiaoLaiCmd.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.laiZiTile != null && message.hasOwnProperty("laiZiTile"))
                if (!$util.isInteger(message.laiZiTile))
        ...
        /**
         * Creates a MahjongPiaoLaiCmd message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a MahjongPiaoLaiCmd message. Also converts values to other types if specified.
         * @function toObject
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {msg.MahjongPiaoLaiCmd} message MahjongPiaoLaiCmd
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this MahjongPiaoLaiCmd to JSON.
         * @function toJSON
         * @memberof msg.MahjongPiaoLaiCmd
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        MahjongPiaoLaiCmd.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for MahjongPiaoLaiCmd
         * @function getTypeUrl
         * @memberof msg.MahjongPiaoLaiCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongPiaoLaiCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongPiaoLaiCmd";
        };

        return MahjongPiaoLaiCmd;
    })();

    msg.MahjongPiaoLaiResult = (function() {

        /**
         * Properties of a MahjongPiaoLaiResult.
         * @memberof msg
         * @interface IMahjongPiaoLaiResult
         * @property {number|null} [laiZiTile] MahjongPiaoLaiResult laiZiTile
         * @property {boolean|null} [ok] MahjongPiaoLaiResult ok
         */

        /**
         * Constructs a new MahjongPiaoLaiResult.
         * @memberof msg
         * @classdesc Represents a MahjongPiaoLaiResult.
         * @implements IMahjongPiaoLaiResult
         * @constructor
         * @param {msg.IMahjongPiaoLaiResult=} [properties] Properties to set
         */
        ...
        /**
         * MahjongPiaoLaiResult laiZiTile.
         * @member {number} laiZiTile
         * @memberof msg.MahjongPiaoLaiResult
         * @instance
         */
        MahjongPiaoLaiResult.prototype.laiZiTile = 0;

        /**
         * MahjongPiaoLaiResult ok.
         * @member {boolean} ok
         * @memberof msg.MahjongPiaoLaiResult
         * @instance
         */
        MahjongPiaoLaiResult.prototype.ok = false;

        /**
         * Creates a new MahjongPiaoLaiResult instance using the specified properties.
         * @function create
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {msg.IMahjongPiaoLaiResult=} [properties] Properties to set
         * @returns {msg.MahjongPiaoLaiResult} MahjongPiaoLaiResult instance
         */
        MahjongPiaoLaiResult.create = function create(properties) {
            return new MahjongPiaoLaiResult(properties);
        };

        /**
         * Encodes the specified MahjongPiaoLaiResult message. Does not implicitly {@link msg.MahjongPiaoLaiResult.verify|verify} messages.
         * @function encode
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {msg.IMahjongPiaoLaiResult} message MahjongPiaoLaiResult message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MahjongPiaoLaiResult.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.laiZiTile != null && Object.hasOwnProperty.call(message, "laiZiTile"))
                writer.uint32(/* id 1, wireType 0 =*/8).sint32(message.laiZiTile);
        ...
        /**
         * Encodes the specified MahjongPiaoLaiResult message, length delimited. Does not implicitly {@link msg.MahjongPiaoLaiResult.verify|verify} messages.
         * @function encodeDelimited
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {msg.IMahjongPiaoLaiResult} message MahjongPiaoLaiResult message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MahjongPiaoLaiResult.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a MahjongPiaoLaiResult message from the specified reader or buffer.
         * @function decode
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {msg.MahjongPiaoLaiResult} MahjongPiaoLaiResult
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ...
        /**
         * Decodes a MahjongPiaoLaiResult message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MahjongPiaoLaiResult.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a MahjongPiaoLaiResult message.
         * @function verify
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MahjongPiaoLaiResult.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.laiZiTile != null && message.hasOwnProperty("laiZiTile"))
                if (!$util.isInteger(message.laiZiTile))
        ...
        /**
         * Creates a MahjongPiaoLaiResult message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a MahjongPiaoLaiResult message. Also converts values to other types if specified.
         * @function toObject
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {msg.MahjongPiaoLaiResult} message MahjongPiaoLaiResult
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this MahjongPiaoLaiResult to JSON.
         * @function toJSON
         * @memberof msg.MahjongPiaoLaiResult
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        MahjongPiaoLaiResult.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for MahjongPiaoLaiResult
         * @function getTypeUrl
         * @memberof msg.MahjongPiaoLaiResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongPiaoLaiResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongPiaoLaiResult";
        };

        return MahjongPiaoLaiResult;
    })();

    msg.MahjongPiaoLaiBroadcast = (function() {

        /**
         * Properties of a MahjongPiaoLaiBroadcast.
         * @memberof msg
         * @interface IMahjongPiaoLaiBroadcast
         * @property {number|null} [userId] MahjongPiaoLaiBroadcast userId
         * @property {number|null} [laiZiTile] MahjongPiaoLaiBroadcast laiZiTile
         * @property {boolean|null} [ok] MahjongPiaoLaiBroadcast ok
         * @property {number|null} [buPaiTile] MahjongPiaoLaiBroadcast buPaiTile
         */

        /**
         * Constructs a new MahjongPiaoLaiBroadcast.
         * @memberof msg
         * @classdesc Represents a MahjongPiaoLaiBroadcast.
         * @implements IMahjongPiaoLaiBroadcast
         * @constructor
         * @param {msg.IMahjongPiaoLaiBroadcast=} [properties] Properties to set
         */
        ...
        /**
         * MahjongPiaoLaiBroadcast userId.
         * @member {number} userId
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @instance
         */
        MahjongPiaoLaiBroadcast.prototype.userId = 0;

        /**
         * MahjongPiaoLaiBroadcast laiZiTile.
         * @member {number} laiZiTile
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @instance
         */
        MahjongPiaoLaiBroadcast.prototype.laiZiTile = 0;

        /**
         * MahjongPiaoLaiBroadcast ok.
         * @member {boolean} ok
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @instance
         */
        MahjongPiaoLaiBroadcast.prototype.ok = false;

        /**
         * MahjongPiaoLaiBroadcast buPaiTile.
         * @member {number} buPaiTile
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @instance
         */
        MahjongPiaoLaiBroadcast.prototype.buPaiTile = 0;

        /**
         * Creates a new MahjongPiaoLaiBroadcast instance using the specified properties.
         * @function create
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {msg.IMahjongPiaoLaiBroadcast=} [properties] Properties to set
         * @returns {msg.MahjongPiaoLaiBroadcast} MahjongPiaoLaiBroadcast instance
         */
        MahjongPiaoLaiBroadcast.create = function create(properties) {
            return new MahjongPiaoLaiBroadcast(properties);
        };

        /**
         * Encodes the specified MahjongPiaoLaiBroadcast message. Does not implicitly {@link msg.MahjongPiaoLaiBroadcast.verify|verify} messages.
         * @function encode
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {msg.IMahjongPiaoLaiBroadcast} message MahjongPiaoLaiBroadcast message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MahjongPiaoLaiBroadcast.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.userId != null && Object.hasOwnProperty.call(message, "userId"))
                writer.uint32(/* id 1, wireType 0 =*/8).sint32(message.userId);
            if (message.laiZiTile != null && Object.hasOwnProperty.call(message, "laiZiTile"))
                writer.uint32(/* id 2, wireType 0 =*/16).sint32(message.laiZiTile);
            if (message.ok != null && Object.hasOwnProperty.call(message, "ok"))
                writer.uint32(/* id 3, wireType 0 =*/24).bool(message.ok);
            if (message.buPaiTile != null && Object.hasOwnProperty.call(message, "buPaiTile"))
                writer.uint32(/* id 4, wireType 0 =*/32).sint32(message.buPaiTile);
            return writer;
        };

        /**
         * Encodes the specified MahjongPiaoLaiBroadcast message, length delimited. Does not implicitly {@link msg.MahjongPiaoLaiBroadcast.verify|verify} messages.
         * @function encodeDelimited
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {msg.IMahjongPiaoLaiBroadcast} message MahjongPiaoLaiBroadcast message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MahjongPiaoLaiBroadcast.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a MahjongPiaoLaiBroadcast message from the specified reader or buffer.
         * @function decode
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {msg.MahjongPiaoLaiBroadcast} MahjongPiaoLaiBroadcast
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MahjongPiaoLaiBroadcast.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                case 4: {
                        message.buPaiTile = reader.sint32();
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        /**
         * Decodes a MahjongPiaoLaiBroadcast message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MahjongPiaoLaiBroadcast.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a MahjongPiaoLaiBroadcast message.
         * @function verify
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MahjongPiaoLaiBroadcast.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.userId != null && message.hasOwnProperty("userId"))
                if (!$util.isInteger(message.userId))
            ...
            if (message.ok != null && message.hasOwnProperty("ok"))
                if (typeof message.ok !== "boolean")
                    return "ok: boolean expected";
            if (message.buPaiTile != null && message.hasOwnProperty("buPaiTile"))
                if (!$util.isInteger(message.buPaiTile))
                    return "buPaiTile: integer expected";
            return null;
        };

        /**
         * Creates a MahjongPiaoLaiBroadcast message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        MahjongPiaoLaiBroadcast.fromObject = function fromObject(object) {
            ...
            if (object.ok != null)
                message.ok = Boolean(object.ok);
            if (object.buPaiTile != null)
                message.buPaiTile = object.buPaiTile | 0;
            return message;
        };

        /**
         * Creates a plain object from a MahjongPiaoLaiBroadcast message. Also converts values to other types if specified.
         * @function toObject
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {msg.MahjongPiaoLaiBroadcast} message MahjongPiaoLaiBroadcast
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MahjongPiaoLaiBroadcast.toObject = function toObject(message, options) {
            ...
            if (message.ok != null && message.hasOwnProperty("ok"))
                object.ok = message.ok;
            if (message.buPaiTile != null && message.hasOwnProperty("buPaiTile"))
                object.buPaiTile = message.buPaiTile;
            return object;
        };

        /**
         * Converts this MahjongPiaoLaiBroadcast to JSON.
         * @function toJSON
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        MahjongPiaoLaiBroadcast.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for MahjongPiaoLaiBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongPiaoLaiBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongPiaoLaiBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongPiaoLaiBroadcast";
        };

        return MahjongPiaoLaiBroadcast;
    })();
    ...
    msg.MahjongLiangGangDingBroadcast = (function() {
        ...
        /**
         * Gets the default type url for MahjongLiangGangDingBroadcast
         * @function getTypeUrl
         * @memberof msg.MahjongLiangGangDingBroadcast
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongLiangGangDingBroadcast.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongLiangGangDingBroadcast";
        };

        return MahjongLiangGangDingBroadcast;
    })();

    msg.MahjongSelectTilePreviewCmd = (function() {

        /**
         * Properties of a MahjongSelectTilePreviewCmd.
         * @memberof msg
         * @interface IMahjongSelectTilePreviewCmd
         * @property {number|null} [selectTile] MahjongSelectTilePreviewCmd selectTile
         */

        /**
         * Constructs a new MahjongSelectTilePreviewCmd.
         * @memberof msg
         * @classdesc Represents a MahjongSelectTilePreviewCmd.
         * @implements IMahjongSelectTilePreviewCmd
         * @constructor
         * @param {msg.IMahjongSelectTilePreviewCmd=} [properties] Properties to set
         */
        ...
        /**
         * MahjongSelectTilePreviewCmd selectTile.
         * @member {number} selectTile
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @instance
         */
        MahjongSelectTilePreviewCmd.prototype.selectTile = 0;

        /**
         * Creates a new MahjongSelectTilePreviewCmd instance using the specified properties.
         * @function create
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {msg.IMahjongSelectTilePreviewCmd=} [properties] Properties to set
         * @returns {msg.MahjongSelectTilePreviewCmd} MahjongSelectTilePreviewCmd instance
         */
        MahjongSelectTilePreviewCmd.create = function create(properties) {
            return new MahjongSelectTilePreviewCmd(properties);
        };

        /**
         * Encodes the specified MahjongSelectTilePreviewCmd message. Does not implicitly {@link msg.MahjongSelectTilePreviewCmd.verify|verify} messages.
         * @function encode
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {msg.IMahjongSelectTilePreviewCmd} message MahjongSelectTilePreviewCmd message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MahjongSelectTilePreviewCmd.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.selectTile != null && Object.hasOwnProperty.call(message, "selectTile"))
                writer.uint32(/* id 1, wireType 0 =*/8).sint32(message.selectTile);
            return writer;
        };

        /**
         * Encodes the specified MahjongSelectTilePreviewCmd message, length delimited. Does not implicitly {@link msg.MahjongSelectTilePreviewCmd.verify|verify} messages.
         * @function encodeDelimited
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {msg.IMahjongSelectTilePreviewCmd} message MahjongSelectTilePreviewCmd message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MahjongSelectTilePreviewCmd.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a MahjongSelectTilePreviewCmd message from the specified reader or buffer.
         * @function decode
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {msg.MahjongSelectTilePreviewCmd} MahjongSelectTilePreviewCmd
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MahjongSelectTilePreviewCmd.decode = function decode(reader, length, error) {
            ...
            while (reader.pos < end) {
                ...
                switch (tag >>> 3) {
                case 1: {
                        message.selectTile = reader.sint32();
                        break;
                    }
                default:
                    reader.skipType(tag & 7);
        ...
        /**
         * Decodes a MahjongSelectTilePreviewCmd message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MahjongSelectTilePreviewCmd.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a MahjongSelectTilePreviewCmd message.
         * @function verify
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MahjongSelectTilePreviewCmd.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.selectTile != null && message.hasOwnProperty("selectTile"))
                if (!$util.isInteger(message.selectTile))
                    return "selectTile: integer expected";
            return null;
        };

        /**
         * Creates a MahjongSelectTilePreviewCmd message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a MahjongSelectTilePreviewCmd message. Also converts values to other types if specified.
         * @function toObject
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {msg.MahjongSelectTilePreviewCmd} message MahjongSelectTilePreviewCmd
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        MahjongSelectTilePreviewCmd.toObject = function toObject(message, options) {
            ...
            if (options.defaults)
                object.selectTile = 0;
            if (message.selectTile != null && message.hasOwnProperty("selectTile"))
                object.selectTile = message.selectTile;
            return object;
        };

        /**
         * Converts this MahjongSelectTilePreviewCmd to JSON.
         * @function toJSON
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        MahjongSelectTilePreviewCmd.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for MahjongSelectTilePreviewCmd
         * @function getTypeUrl
         * @memberof msg.MahjongSelectTilePreviewCmd
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongSelectTilePreviewCmd.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongSelectTilePreviewCmd";
        };

        return MahjongSelectTilePreviewCmd;
    })();

    msg.MahjongSelectTilePreviewResult = (function() {

        /**
         * Properties of a MahjongSelectTilePreviewResult.
         * @memberof msg
         * @interface IMahjongSelectTilePreviewResult
         * @property {Array.<number>|null} [huTileArray] MahjongSelectTilePreviewResult huTileArray
         */

        /**
         * Constructs a new MahjongSelectTilePreviewResult.
         * @memberof msg
         * @classdesc Represents a MahjongSelectTilePreviewResult.
         * @implements IMahjongSelectTilePreviewResult
         * @constructor
         * @param {msg.IMahjongSelectTilePreviewResult=} [properties] Properties to set
         */
        ...
        /**
         * MahjongSelectTilePreviewResult huTileArray.
         * @member {Array.<number>} huTileArray
         * @memberof msg.MahjongSelectTilePreviewResult
         * @instance
         */
        MahjongSelectTilePreviewResult.prototype.huTileArray = $util.emptyArray;

        /**
         * Creates a new MahjongSelectTilePreviewResult instance using the specified properties.
         * @function create
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {msg.IMahjongSelectTilePreviewResult=} [properties] Properties to set
         * @returns {msg.MahjongSelectTilePreviewResult} MahjongSelectTilePreviewResult instance
         */
        MahjongSelectTilePreviewResult.create = function create(properties) {
            return new MahjongSelectTilePreviewResult(properties);
        };

        /**
         * Encodes the specified MahjongSelectTilePreviewResult message. Does not implicitly {@link msg.MahjongSelectTilePreviewResult.verify|verify} messages.
         * @function encode
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {msg.IMahjongSelectTilePreviewResult} message MahjongSelectTilePreviewResult message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
        MahjongSelectTilePreviewResult.encode = function encode(message, writer) {
            if (!writer)
                writer = $Writer.create();
            if (message.huTileArray != null && message.huTileArray.length) {
                writer.uint32(/* id 1, wireType 2 =*/10).fork();
        ...
        /**
         * Encodes the specified MahjongSelectTilePreviewResult message, length delimited. Does not implicitly {@link msg.MahjongSelectTilePreviewResult.verify|verify} messages.
         * @function encodeDelimited
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {msg.IMahjongSelectTilePreviewResult} message MahjongSelectTilePreviewResult message or plain object to encode
         ...
         * @returns {$protobuf.Writer} Writer
         */
        MahjongSelectTilePreviewResult.encodeDelimited = function encodeDelimited(message, writer) {
            return this.encode(message, writer).ldelim();
        };

        /**
         * Decodes a MahjongSelectTilePreviewResult message from the specified reader or buffer.
         * @function decode
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {msg.MahjongSelectTilePreviewResult} MahjongSelectTilePreviewResult
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ...
        /**
         * Decodes a MahjongSelectTilePreviewResult message from the specified reader or buffer, length delimited.
         * @function decodeDelimited
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        MahjongSelectTilePreviewResult.decodeDelimited = function decodeDelimited(reader) {
            if (!(reader instanceof $Reader))
                reader = new $Reader(reader);
            return this.decode(reader, reader.uint32());
        };
        ...
        /**
         * Verifies a MahjongSelectTilePreviewResult message.
         * @function verify
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {Object.<string,*>} message Plain object to verify
         * @returns {string|null} `null` if valid, otherwise the reason why it is not
         */
        MahjongSelectTilePreviewResult.verify = function verify(message) {
            if (typeof message !== "object" || message === null)
                return "object expected";
            if (message.huTileArray != null && message.hasOwnProperty("huTileArray")) {
                if (!Array.isArray(message.huTileArray))
        ...
        /**
         * Creates a MahjongSelectTilePreviewResult message from a plain object. Also converts values to their respective internal types.
         * @function fromObject
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {Object.<string,*>} object Plain object
        ...
        /**
         * Creates a plain object from a MahjongSelectTilePreviewResult message. Also converts values to other types if specified.
         * @function toObject
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {msg.MahjongSelectTilePreviewResult} message MahjongSelectTilePreviewResult
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        /**
         * Converts this MahjongSelectTilePreviewResult to JSON.
         * @function toJSON
         * @memberof msg.MahjongSelectTilePreviewResult
         * @instance
         * @returns {Object.<string,*>} JSON object
         */
        MahjongSelectTilePreviewResult.prototype.toJSON = function toJSON() {
            return this.constructor.toObject(this, $protobuf.util.toJSONOptions);
        };

        /**
         * Gets the default type url for MahjongSelectTilePreviewResult
         * @function getTypeUrl
         * @memberof msg.MahjongSelectTilePreviewResult
         * @static
         * @param {string} [typeUrlPrefix] your custom typeUrlPrefix(default "type.googleapis.com")
         * @returns {string} The default type url
         */
        MahjongSelectTilePreviewResult.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            if (typeUrlPrefix === undefined) {
                typeUrlPrefix = "type.googleapis.com";
            }
            return typeUrlPrefix + "/msg.MahjongSelectTilePreviewResult";
        };

        return MahjongSelectTilePreviewResult;
    })();
