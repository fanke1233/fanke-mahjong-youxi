...
export namespace msg {
    ...
    /** Represents an ApprovalResultBroadcast. */
    class ApprovalResultBroadcast implements IApprovalResultBroadcast {

        /**
         * Constructs a new ApprovalResultBroadcast.
         * @param [properties] Properties to set
         */
        constructor(properties?: msg.IApprovalResultBroadcast);
         ...
         * @param [properties] Properties to set
         * @returns ApprovalResultBroadcast instance
         */
        public static create(properties?: msg.IApprovalResultBroadcast): msg.ApprovalResultBroadcast;
         ...
         * @param message ApprovalResultBroadcast message or plain object to encode
         * @param [writer] Writer to encode to
         * @returns Writer
         */
        public static encode(message: msg.IApprovalResultBroadcast, writer?: $protobuf.Writer): $protobuf.Writer;
         ...
         * @returns Writer
         */
        public static encodeDelimited(message: msg.IApprovalResultBroadcast, writer?: $protobuf.Writer): $protobuf.Writer;

        /**
         * Decodes an ApprovalResultBroadcast message from the specified reader or buffer.
         * @param reader Reader or buffer to decode from
         * @param [length] Message length if known beforehand
         * @returns ApprovalResultBroadcast
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decode(reader: ($protobuf.Reader|Uint8Array), length?: number): msg.ApprovalResultBroadcast;
         ...
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        public static decodeDelimited(reader: ($protobuf.Reader|Uint8Array)): msg.ApprovalResultBroadcast;
         ...
         * @returns ApprovalResultBroadcast
         */
        public static fromObject(object: { [k: string]: any }): msg.ApprovalResultBroadcast;

        /**
         * Creates a plain object from an ApprovalResultBroadcast message. Also converts values to other types if specified.
         * @param message ApprovalResultBroadcast
         * @param [options] Conversion options
         * @returns Plain object
         */
        public static toObject(message: msg.ApprovalResultBroadcast, options?: $protobuf.IConversionOptions): { [k: string]: any };
