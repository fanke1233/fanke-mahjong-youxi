...
import MahjongPiaoLaiBroadcastHandler from "./MahjongPiaoLaiBroadcastHandler";
import MahjongPiaoLaiResultHandler from "./MahjongPiaoLaiResultHandler";
...
function __getMsgHandlerMap(): { [strKey: string]: any, } {
    ...
    oMap["MahjongPiaoLaiBroadcast"] = MahjongPiaoLaiBroadcastHandler;
    oMap["MahjongPiaoLaiResult"] = MahjongPiaoLaiResultHandler;
